...
public class DialogueTrigger : MonoBehaviour
{
    ...
    void NextDialogue()
    {
        ...
        else
        {
            ...
            if (hudArma != null) hudArma.SetActive(true);
            if (armaPlayer != null) armaPlayer.SetActive(true);
            if (hudVida != null) hudVida.SetActive(true);
            if (questOnHud != null) questOnHud.SetActive(true);
